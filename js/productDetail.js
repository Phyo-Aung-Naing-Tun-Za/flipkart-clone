...
import {  customerMightInterest, similarProducts } from "../Data/forProdutDetailPage/products.js";
...
productDetailPageCategories.forEach((category) => {
  ...
  productDetailsToggler.addEventListener('click',(e)=>{
    ...
    selectAnElement('#prduct-details-toggler #plus-btn').classList.toggle('hidden');
    selectAnElement('#prduct-details-toggler #minus-btn').classList.toggle('hidden');
  });

  // for customer upload imgs sections

  let customerUploadImgsContainer = selectAnElement('#customerUploadImgsContainer');
  ...
  let cardContainer = selectAnElement('#customer-interest-section #card-container');
  ...
  let similarProductsContainer = selectAnElement('#similar-products-section #similar-products-container');

  similarProducts.forEach(product => generateProductCards(product,similarProductsContainer) );
...
let recentViewProductContainer = selectAnElement('#recent-view-section #recent-view-container');
similarProducts.forEach(product => generateProductCards(product,recentViewProductContainer));
generateScrollBtn(
  ...
  function generateProductCards(product,container) {
    ...
    productName.classList.add("truncate", "text-[14px]", "text-black", "mb-1","title");
